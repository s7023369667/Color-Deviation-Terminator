...
#handler = WebhookHandler('c7dea962820c73a58a907530bf8887e8')
...
def handle_message(event):  # 收到訊息時
    ...
    if msg == 'hi': #起始
        ...
        if error == 0:  # 輸入正確時
            ...
            make_img(rgb)
            img_link = 'https://limitless-lowlands-17434.herokuapp.com'+'/color_fig/b{0}g{1}r{2}.jpg'.format(rgb[2], rgb[1], rgb[0])
